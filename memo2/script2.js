    ...
    tileClick(e) {
        if (this.canGet) {
            ...
            if (this.tilesChecked.length === 2) {
                ...
                this.divScore.innerText = 'eLiczba odsłon: ' + this.divScore.innerText +', data: '+ this.dataczas.toLocaleDateString() +', godzina: '+ this.dataczas.getHours() +':'+ this.dataczas.getMinutes() +':'+ this.dataczas.getSeconds();
            }
        }
    },
